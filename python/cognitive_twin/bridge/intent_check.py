...
def _check_profile_bias(intent: str, output: str, profile) -> Optional[str]:
    ...
    Heuristic: if anchors dominate the output but weren't part of the
    intent, the profile may be over-steering.
    """
    ...
    # Check if anchors appear in output but not in intent
