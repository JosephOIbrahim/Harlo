...
Order of precedence:
  1. launchd  — launch_activate_socket(3) (macOS; the OS owns the node)
  2. systemd  — LISTEN_FDS / fd 3 (Linux; the OS owns the node)
  3. dev mode — bind SOCKET_PATH ourselves (we own the node),
                refusing to hijack a live listener.
