...
class TestRule08_JSONBarrier:
    ...
    def test_valid_payload_passes(self):
        from src.modulation.barrier import validate_llm_output
    ...
    def test_epigenetic_wash_stripped(self):
        from src.modulation.barrier import strip_epigenetic_wash
...
class TestRule10_Anchors:
    ...
    def test_anchors_always_gain_1(self):
        from src.modulation.gain import compute_gain
...
class TestRule12_VerifiedOnly:
    ...
    def test_verified_consolidates(self, tmp_path, monkeypatch):
        from src.bridge import consolidation
...
class TestRule23_InhibitionDefault:
    ...
    def test_default_is_inhibit(self):
        from src.motor.basal_ganglia import gate, GateDecision
    ...
    def test_single_failure_inhibits(self):
        from src.motor.basal_ganglia import gate, GateDecision
        from src.motor.consent import ConsentState
        from src.motor.premotor import PlannedAction
...
class TestRule25_Level3Locked:
    ...
    def test_locked_never_opens(self):
        from src.motor.consent import ConsentLevel, ConsentState, is_locked
    ...
    def test_basal_ganglia_rejects_locked(self):
        from src.motor.basal_ganglia import gate, GateDecision
        from src.motor.consent import ConsentLevel, ConsentState
        from src.motor.premotor import PlannedAction
        from src.motor.scope import Scope
...
class TestRule29_ReversibilityCap:
    ...
    def test_session_irreversible_becomes_per_action(self):
        from src.motor.consent import ConsentLevel, effective_consent_level
...
class TestRule32_MotorZeroTolerance:
    ...
    def test_single_failure_decompiles(self):
        from src.motor.motor_cerebellum import MotorCerebellum, ActionPattern
...
class TestSafeguardS1_Apophenia:
    ...
    def test_insufficient_evidence_blocked(self):
        from src.inquiry.apophenia_guard import EvidenceBundle, evaluate
    ...
    def test_thresholds_per_depth(self, depth, threshold):
        from src.inquiry.types import EVIDENCE_THRESHOLDS
...
class TestSafeguardS2_EpistemologicalBypass:
    ...
    def test_inquiry_source_bypasses(self):
        from src.bridge.epistemological_bypass import should_bypass_aletheia
...
class TestSafeguardS3_Rupture:
    ...
    def test_rejection_weight_is_2(self):
        from src.inquiry.rupture_repair import REJECTION_WEIGHT

        assert REJECTION_WEIGHT == 2.0

    def test_rejection_trace_weight(self):
        from src.inquiry.rupture_repair import RejectionTrace
    ...
    def test_three_rejections_offer_stop(self):
        from src.inquiry.rupture_repair import RuptureLedger
...
class TestSafeguardS5_InquiryApoptosis:
    ...
    def test_vitality_at_zero(self):
        from src.inquiry.apoptosis import InquiryVitality, VITALITY_THRESHOLD
        from src.inquiry.types import InquiryType
    ...
    def test_vitality_decays(self):
        from src.inquiry.apoptosis import InquiryVitality
        from src.inquiry.types import InquiryType
    ...
    def test_formula_e_neg_3t_over_ttl(self):
        ...
        from src.inquiry.apoptosis import InquiryVitality, DECAY_K
        from src.inquiry.types import InquiryType
...
class TestSafeguardS7_Crystallization:
    ...
    def test_max_50_cap(self):
        from src.inquiry.crystallization import (
    ...
    def test_eviction_removes_lowest_score(self):
        from src.inquiry.crystallization import CrystallizationStore
    ...
    def test_decay_rate_reduced(self):
        from src.inquiry.crystallization import CrystallizationStore, DECAY_DIVISOR
