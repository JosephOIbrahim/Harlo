...
class TestEscalation:
    ...
    def test_low_confidence_escalates(self):
        from harlo.brainstem.escalation import should_escalate
...
class TestAmygdala:
    ...
    def test_safety_triggers_amygdala(self):
        from harlo.brainstem.amygdala import is_amygdala_trigger
    ...
    def test_amygdala_reflex_is_permanent(self):
        from harlo.brainstem.amygdala import create_amygdala_reflex
...
class TestEpistemologicalBypass:
    ...
    def test_perception_gap_emitted(self):
        ...
        from harlo.brainstem.epistemological_bypass import emit_perception_gap
