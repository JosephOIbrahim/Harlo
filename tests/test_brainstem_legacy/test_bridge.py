"""Tests for the Brainstem Protocol (formerly Bridge — Corpus Callosum + Amygdala).
...
class TestEscalation:
    ...
    def test_low_confidence_escalates(self):
        from cognitive_twin.brainstem.escalation import should_escalate
...
class TestAmygdala:
    ...
    def test_safety_triggers_amygdala(self):
        from cognitive_twin.brainstem.amygdala import is_amygdala_trigger
    ...
    def test_amygdala_reflex_is_permanent(self):
        from cognitive_twin.brainstem.amygdala import create_amygdala_reflex
...
class TestConsolidation:
    ...
    def test_verified_consolidates(self):
        from cognitive_twin.brainstem.consolidation import consolidate_resolution
...
class TestIntentCheck:
    ...
    def test_intent_preserved(self):
        from cognitive_twin.brainstem.intent_check import check_intent_preserved
...
class TestEpistemologicalBypass:
    ...
    def test_perception_gap_emitted(self):
        ...
        from cognitive_twin.brainstem.epistemological_bypass import emit_perception_gap
...
class TestReflexCompiler:
    ...
    def test_compile_verified(self):
        from cognitive_twin.brainstem.reflex_compiler import compile_to_reflex
...
class TestCompliance:
    ...
    def test_no_sleep_in_brainstem_bridge_modules(self):
        import inspect
        from cognitive_twin.brainstem import (
    ...
    def test_no_while_true_in_brainstem_bridge_modules(self):
        import inspect
        from cognitive_twin.brainstem import (
            escalation, amygdala, consolidation,
            integrity, intent_check, epistemological_bypass,
