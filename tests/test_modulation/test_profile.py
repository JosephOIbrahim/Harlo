...
class TestProfile:
    ...
    def test_load_default_profile(self):
        from src.modulation.profile import load_profile
        from src.daemon.config import PROFILE_PATH
...
class TestGain:
    ...
    def test_apply_modulation_preserves_clean(self):
        from src.modulation.gain import apply_modulation
...
class TestAllostasis:
    ...
    def test_initial_load_zero(self):
        from src.modulation.allostatic import AllostasisTracker
    ...
    def test_no_sleep_no_polling(self):
        ...
        import inspect
        from src.modulation import allostatic
...
class TestDetector:
    ...
    def test_detect_default(self):
        from src.modulation.detector import detect_pattern
...
class TestCompliance:
    ...
    def test_no_sleep_in_modulation(self):
        ...
        import inspect
        from src.modulation import profile, gain, allostatic, barrier, detector
