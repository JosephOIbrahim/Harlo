...
class TestProfile:
    ...
    def test_load_default_profile(self):
        from harlo.modulation.profile import load_profile
        from harlo.daemon.config import PROFILE_PATH
...
class TestAllostasis:
    ...
    def test_no_sleep_no_polling(self):
        ...
        import inspect
        from harlo.modulation import allostatic
...
class TestCompliance:
    ...
    def test_no_sleep_in_modulation(self):
        ...
        import inspect
        from harlo.modulation import profile, gain, allostatic, barrier, detector
