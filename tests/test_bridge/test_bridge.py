...
class TestEscalation:
    ...
    def test_low_confidence_escalates(self):
        from src.bridge.escalation import should_escalate
...
class TestAmygdala:
    ...
    def test_safety_triggers_amygdala(self):
        from src.bridge.amygdala import is_amygdala_trigger
    ...
    def test_amygdala_reflex_is_permanent(self):
        from src.bridge.amygdala import create_amygdala_reflex
...
class TestConsolidation:
    ...
    def test_verified_consolidates(self):
        from src.bridge.consolidation import consolidate_resolution
...
class TestIntentCheck:
    ...
    def test_intent_preserved(self):
        from src.bridge.intent_check import check_intent_preserved
...
class TestEpistemologicalBypass:
    ...
    def test_perception_gap_emitted(self):
        ...
        from src.bridge.epistemological_bypass import emit_perception_gap
...
class TestReflexCompiler:
    ...
    def test_compile_verified(self):
        from src.bridge.reflex_compiler import compile_to_reflex
