...
class TestInquiryTypes:
    ...
    def test_ttl_values(self):
        from src.inquiry.types import InquiryType, TTL_HOURS
...
class TestApopheniaGuard:
    ...
    def test_low_evidence_blocked(self):
        from src.inquiry.apophenia_guard import evaluate, EvidenceBundle
...
class TestSincerityGate:
    ...
    def test_default_is_sincere(self):
        from src.inquiry.sincerity_gate import classify, SincerityClass
...
class TestRuptureRepair:
    ...
    def test_rejection_trace_is_permanent(self):
        from src.inquiry.rupture_repair import RejectionTrace, REJECTION_WEIGHT
...
class TestCrystallization:
    ...
    def test_max_crystallized_50(self):
        from src.inquiry.crystallization import MAX_CRYSTALLIZED
