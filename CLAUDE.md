...
Rust hot path + Python orchestration + Aletheia verification +
...
Verification Engine (Aletheia GVR), one Inquiry Engine (DMN), and
...
S2. EPISTEMOLOGICAL BYPASS: Inquiry outputs verified for tone +
    ...
    Aletheia ONLY when consumed by src/inquiry/ namespace.
...
20. PERCEPTION GAP TRACES: When Aletheia falsifies self_reported
...
33. BLIND SPOT ACCEPTANCE: If user rejects perception_gap inquiry,
    tag claim as blind_spot_accepted. Aletheia keeps using objective
