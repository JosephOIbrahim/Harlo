// SampleEncoder — converts an HKSample into a JSON payload matching
// config/biometric_sample_schema.json. Returns nil for types Harlo
// does not handle.
//
// Direct port of macos/HarloHealthBridge/Sources/.../BiometricEncoder.swift:
// identical 9-type switch, identical HKUnit choices, identical JSON
// fields (type/value/unit/sampled_at/source). Schema-exact — the
// daemon's biometric_barrier (Rule 9) is the enforcement point.
